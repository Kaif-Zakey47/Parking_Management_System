...
public class ParkingSpaceController {
    ...
    // Filter parking spaces by location
    ...
    // Filter parking spaces by owner
    ...
    // Occupy a parking space (vehicle entry)
    ...
    public String occupyParkingSpace(@PathVariable String spaceId, @RequestParam String vehicleId) {
        ...
        // Clear reservation if it was reserved
    ...
    // Release a parking space (vehicle exit)
    ...
    // Update parking space status manually
